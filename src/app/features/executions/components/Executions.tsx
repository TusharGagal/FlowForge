"use client"
import { EmptyView, EntityContainer, EntityHeader, EntityList, EntityListItem, EntityPagination, ErrorView, LoadingView } from "@/components/entity-components";
...
import { useExecutionsParams } from "../hooks/useExecutions-params";
...
export const ExecutionsError = () => {
    return (
        <ErrorView message="Error while loading Executions!!" />
    )
}
